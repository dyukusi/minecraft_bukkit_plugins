...
public class NormalCreeper extends EntityCreeper {
	...
	public NormalCreeper(World world, List<Location> dest_list) {
		// super(world);
		...
		this.goalSelector
				.a(4, new PathfinderGoalMeleeAttack(this, 1.0D, false));

		// move to specified point
		this.goalSelector.a(4, new PathfinderGoalWalktoTile(this, dest_list,
				1.0D));
