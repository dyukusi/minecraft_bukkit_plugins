	...
	public void send(Player player) {
		if (packetTitle != null) {
			...
			try {
				...
				Object packet = packetTitle.getConstructor(packetActions, chatBaseComponent, Integer.TYPE,
						Integer.TYPE, Integer.TYPE).newInstance(actions[2], null, fadeInTime * (ticks ? 1 : 20),
				...
				// Send title
				Object serialized = getMethod(nmsChatSerializer, "a", String.class).invoke(
						null,
				...
				if (subtitle != "") {
					...
					serialized = getMethod(nmsChatSerializer, "a", String.class).invoke(
							null,
